...
What I do
Table
🌲 GIS & Tree Cadastre	📊 Data Extraction & ETL	🧪 Strategy Audit
Drone imagery → GIS-ready inventory. 10k+ trees mapped from a single flight.	German invoice PDFs → validated CSV/Excel. Raw exchange feeds → gap-free archives.	OOS split + Bonferroni correction. I ran 256 variants of my own strategy through it: 0 passed. 0 deployed.
Python · QGIS · GeoJSON	Python · Pandas · Linux · VPS	Python · SciPy · Statistics
Case study →	Case study →	See the audit →
Proof of work
...
How we work together
    ...
    You send the mess — PDFs, raw feeds, CSV chaos, a strategy idea
    I audit & scope — 24h turnaround on feasibility + fixed quote
    I build & document — you get code, access, README, no lock-in
    I step off — the pipeline runs without me
